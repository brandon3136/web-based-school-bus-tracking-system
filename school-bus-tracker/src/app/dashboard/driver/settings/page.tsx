...
import {
  MapPin, Users, Clock, User, Phone, Mail,
  Lock, Eye, EyeOff, KeyRound, AlertTriangle, CheckCircle2,
  Shield, Calendar,
} from "lucide-react";
...
export default function DriverSettings() {
  ...
  return (
    <div className="flex min-h-screen" style={{ backgroundColor: "var(--surface)" }}>
      <Sidebar role="driver" items={NAV} accentColor="#F5A623" userName={profile?.name || "Driver"} />
              ...
              {sections.map(s => {
                ...
                return (
                  <button key={s.id} onClick={() => setActiveSection(s.id)}
                    ...
                    style={isActive
                      ? { backgroundColor: "color-mix(in srgb, #F5A623 15%, transparent)", color: "#F5A623" }
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0"
                        style={{ backgroundColor: "color-mix(in srgb, #F5A623 15%, transparent)", color: "#F5A623" }}>
                        <Shield size={16} /></div>
                      <div>
                ...
                <div className="rounded-2xl border p-6" style={{ backgroundColor: "var(--card)", borderColor: "var(--border)" }}>
                  ...
                  <form onSubmit={handleSaveProfile} className="space-y-4 max-w-md">
                    ...
                    <label className="space-y-1.5 block">
                      ...
                      {profileForm.email !== profile.email && (
                        <p className="text-xs" style={{ color: "#F5A623" }}>
                          This will change your login email. Use the new email next time you sign in.
                        </p>
                      )}
                    </label>
                    <label className="space-y-1.5 block">
                    ...
                    <button type="submit" disabled={profileSaving}
                      ...
                      style={{ backgroundColor: "#F5A623", color: "var(--navy)" }}>
